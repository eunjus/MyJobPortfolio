...
{
    public class RULE_SALARYPAPMANAGEMENT
    {
        //CUBRID DB 연결 정보
        ...
        public RULE_SALARYPAPMANAGEMENT()
        {
            //필드 초기화
        ...
        public DataTable SearchCommon(Dictionary<string, string> MessageSet)
        {
            ...
            if (SearchType == "seachStaffInfo")
            {
                string sql = " SELECT" +
                    ...
                    "                 a.staff_name  " +                                        
                    " 	        FROM 	" +
                    "               mng_staff a INNER JOIN mng_bank b ON a.staff_id = b.id   " +
                    "           WHERE 1 = 1 " +
                    "                 AND b.staff_type_id != 'JWP03' ";
        ...
        public DataSet Search(Dictionary<string,string> MessageSet)
        {
            ...
            sql = "	WITH " +
                    ...
                    "	IFNULL(a.food_cost, 0) food_cost, " +
                    ...
                    "	IFNULL(f.sum_foodcosts, 0) sum_foodcosts, " +
