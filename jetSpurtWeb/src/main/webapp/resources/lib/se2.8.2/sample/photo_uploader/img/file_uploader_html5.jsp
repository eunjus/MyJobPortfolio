...
<%
	...
	String path = "C:/Temp/JetspurtWeb/upload/";
...
// 	}
	...
	sFileInfo += "&bNewLine=true&sFileName="+ name+"&sFileURL=" + "C:/Temp/JetspurtWeb/upload/" + realname;
	
	String sfileURL = "C:/Temp/JetspurtWeb/upload/" + realname;
...
<img src="<%=sfileURL%>" id="copyImg" border="0" />
...
$(window).load(
	function (){
	   ...
	   alert("이미지가 복사되었습니다. 붙여넣기 (Ctrl+V)를 이용하시면 됩니다.");
	  }     		
	);
