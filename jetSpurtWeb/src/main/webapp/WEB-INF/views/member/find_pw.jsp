...
<div class="sub_menu">
    ...
    <dl>
		...
		<dd class="menu03 on"><a href="${pageContext.request.contextPath}/member.do?code=find_pw">비밀번호 찾기</a></dd>
				...
				<!-- #네비게이션 시작 .nav_wrap -->
					...
					<div class="nav_wrap">
						<div class="nav_box">
							...
							<p>
									비밀번호를 잊으셨나요? 회원가입시 입력한 정보를 입력해주세요.
							</p>
							<ul>
...
<div class="sub_content">
	<div class="sub_login">
		<div class="login_box">
			<form action="find_pw.do" name=frm method="post" accept-charset="utf-8">

			<fieldset>
			<legend>회원 아이디, 이름, 이메일 정보로 분실한 비밀번호 찾기</legend>
			<input type="hidden" name="mode" value="find_pw" />
			<ul>
				<li><input type="text" name="userid" id="userid" value="" placeholder="아이디"><label for="userid" class="dn">회원아이디</label></li>
				<li><input type="text" name="username" id="username" value="" placeholder="이름"><label for="name" class="dn">회원이름</label></li>
				<li><input type="text" name="email" id="email" value="" placeholder="이메일"><label for="email" class="dn">회원이메일</label></li>
				<li><button type="submit" class="btn_wd btn_point">SEARCH</button></li>
			</ul>
			</fieldset>
			</form>
			<ul class="login_link">
				<li><a href="${pageContext.request.contextPath}/member.do?code=login">로그인</a></li>
				<li><a href="/member/find_id">아이디찾기</a></li>
